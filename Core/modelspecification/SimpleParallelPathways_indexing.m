...
%%% the simple 1d test model. As a result, specific state variables
%%% of the state x can be indexed in a human readable format, e.g., to
%%% access A, use x(I.A). 
%%% Analogously, the parameter k_d can be accessed via par(I.k_d) etc. 
%%%
%%% Input: none
%%%
...
function I  =  SimpleParallelPathways_indexing

%%% define state index structure 
%%%
I.nmstate = {'A','S','B','C','D'}; % name (nm) of states
...
%%%
I.nmpar = {'k_ab','k_b','k_bd','k_ac','k_c','k_cd','k_d'}; % name (nm) of parameters
