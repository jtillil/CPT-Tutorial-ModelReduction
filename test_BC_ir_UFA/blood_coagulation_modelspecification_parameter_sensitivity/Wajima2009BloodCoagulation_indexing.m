...
I.nmstate = {'XII','XIIa','VIII','VIIIa','IX','IXa','XI','XIa','VII','VIIa','X',...
    ...
    'delayTaipan1','delayTaipan2','AVenom_Tiger','CVenom_Tiger','AT_III_UFH','lump',...
    'v1','k1',... % name (nm) of parameters
    'v2','k2',...
    'v3','k3',...
    'v4','k4',...
    'v5','k5',...
  ...
  'degFg','degF','degXF','degII','degIIa','degTF','degV','degVa','degVII','degVIIa','degVIII',...
    ...
    'd_Taipan','ktrans_Taipan','ka_Tiger','d_Tiger','inf_rate_UFH','vtaipan','ktaipan'}; %,'PT'
...
if ~isempty(intersect(I.nmstate,I.nmpar))
    fprintf('--> There is an overlap between state and parameter names :-( Please fix!\n\n');
    error('--> Ending here');
end
