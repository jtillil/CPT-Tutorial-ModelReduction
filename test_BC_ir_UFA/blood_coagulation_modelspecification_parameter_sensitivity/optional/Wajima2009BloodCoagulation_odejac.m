...
DF(I.Fg,I.IIa)    = -(par(I.v14))/(par(I.k14)+2*X(I.IIa)+X(I.IIa)^2/par(I.k14))*X(I.Fg);
...
DF(I.F,I.XIIIa)   = -(par(I.v16))/(par(I.k16)+2*X(I.XIIIa)+X(I.XIIIa)^2/par(I.k16))*X(I.F);
DF(I.F,I.P)       = -(par(I.v17))/(par(I.k17)+2*X(I.P)+X(I.P)^2/par(I.k17))*X(I.F);
...
DF(I.XF,I.XIIIa)  = (par(I.v16))/(par(I.k16)+2*X(I.XIIIa)+X(I.XIIIa)/par(I.k16))*X(I.F);
