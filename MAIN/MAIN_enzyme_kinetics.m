...
lumpmat(3, model.I.C) = 1;
lumpmat(4, model.I.P) = 1;
reduced_errors.lumping_S_E(1,3) = calculate_lumping_error(model, lumpmat);
...
lumpmat(3, model.I.C) = 1;
lumpmat(4, model.I.P) = 1;
reduced_errors.lumping_A_S(1,3) = calculate_lumping_error(model, lumpmat);
...
lumpmat(3, model.I.C) = 1;
lumpmat(4, model.I.P) = 1;
reduced_errors.lumping_E_C(1,3) = calculate_lumping_error(model, lumpmat);
