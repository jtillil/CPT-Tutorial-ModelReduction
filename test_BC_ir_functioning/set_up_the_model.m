...
I.nm_indices = {'ir','contr','obs','env','pss','pneg','cneg'};
I.nm_non_ir_indices = {'env','pss','pneg','cneg'};

I.stateclasses = {'dyn','env','pss','pneg','cneg'};
I.nondynstateclasses = {'env','pss','pneg','cneg'};
